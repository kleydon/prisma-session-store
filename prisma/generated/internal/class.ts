...
> {
  ...
  /**
   * `prisma.otherSession`: Exposes CRUD operations for the **OtherSession** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more OtherSessions
   * const otherSessions = await prisma.otherSession.findMany()
   * ```
   */
  get otherSession(): Prisma.OtherSessionDelegate<ExtArgs, { omit: OmitOpts }>;
}
